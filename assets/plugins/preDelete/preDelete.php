		...
		<div class="table-responsive" style="padding:20px;"><h2>Удаление доументов <small>(<?=$count;?>)</small></h2>
			...
			<div id="actions">
				<ul class="actionButtons">			
					<li ><a href="javascript:document.getElementById('act').value=2; document.forms['form'].submit();" id="Button1" style="font-size:0.825rem;">Удалить выбранные</a></li>			
					<li ><a href="javascript:document.forms['form'].submit()" id="Button2" style="font-size:0.825rem;">Удалить ВСЕ</a></li>			
				</ul>
			</div>
